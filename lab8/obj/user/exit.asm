...
0000000000800020 <__panic>:
  ...
  800042:	160000ef          	jal	ra,8001a2 <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	132000ef          	jal	ra,80017c <vcprintf>
  80004e:	00001517          	auipc	a0,0x1
  800052:	82250513          	addi	a0,a0,-2014 # 800870 <main+0x194>
  800056:	14c000ef          	jal	ra,8001a2 <cprintf>
...
0000000000800060 <__warn>:
  ...
  800082:	120000ef          	jal	ra,8001a2 <cprintf>
  800086:	65a2                	ld	a1,8(sp)
  800088:	8522                	mv	a0,s0
  80008a:	0f2000ef          	jal	ra,80017c <vcprintf>
  80008e:	00000517          	auipc	a0,0x0
  800092:	7e250513          	addi	a0,a0,2018 # 800870 <main+0x194>
  800096:	10c000ef          	jal	ra,8001a2 <cprintf>
...
0000000000800122 <exit>:
  ...
  80012e:	70e50513          	addi	a0,a0,1806 # 800838 <main+0x15c>
  800132:	070000ef          	jal	ra,8001a2 <cprintf>
...
000000000080013c <wait>:
  80013c:	4581                	li	a1,0
  80013e:	4501                	li	a0,0
  800140:	fa9ff06f          	j	8000e8 <sys_wait>
...
000000000080014c <_start>:
  80014c:	0d4000ef          	jal	ra,800220 <umain>
  800150:	a001                	j	800150 <_start+0x4>

0000000000800152 <open>:
  800152:	1582                	slli	a1,a1,0x20
  800154:	9181                	srli	a1,a1,0x20
  800156:	fabff06f          	j	800100 <sys_open>

000000000080015a <close>:
  80015a:	fb3ff06f          	j	80010c <sys_close>

000000000080015e <dup2>:
  80015e:	fb9ff06f          	j	800116 <sys_dup>
...
0000000000800162 <cputch>:
  ...
  80016a:	f8fff0ef          	jal	ra,8000f8 <sys_putc>
...
000000000080017c <vcprintf>:
  ...
  80018a:	fdc50513          	addi	a0,a0,-36 # 800162 <cputch>
  ...
  800196:	19a000ef          	jal	ra,800330 <vprintfmt>
...
00000000008001a2 <cprintf>:
  ...
  8001ba:	fac50513          	addi	a0,a0,-84 # 800162 <cputch>
  ...
  8001d0:	160000ef          	jal	ra,800330 <vprintfmt>
...
00000000008001dc <initfd>:
  ...
  8001ec:	f67ff0ef          	jal	ra,800152 <open>
  ...
  800208:	f53ff0ef          	jal	ra,80015a <close>
  80020c:	85a6                	mv	a1,s1
  80020e:	8522                	mv	a0,s0
  800210:	f4fff0ef          	jal	ra,80015e <dup2>
  800214:	84aa                	mv	s1,a0
  800216:	8522                	mv	a0,s0
  800218:	f43ff0ef          	jal	ra,80015a <close>
...
0000000000800220 <umain>:
  ...
  80025c:	ec7ff0ef          	jal	ra,800122 <exit>
  ...
  800274:	dedff0ef          	jal	ra,800060 <__warn>
  ...
  80028e:	dd3ff0ef          	jal	ra,800060 <__warn>
...
00000000008006dc <main>:
  ...
  8006ea:	ab9ff0ef          	jal	ra,8001a2 <cprintf>
  8006ee:	a4bff0ef          	jal	ra,800138 <fork>
  ...
  800700:	aa3ff0ef          	jal	ra,8001a2 <cprintf>
  ...
  800710:	a93ff0ef          	jal	ra,8001a2 <cprintf>
  800714:	006c                	addi	a1,sp,12
  800716:	8522                	mv	a0,s0
  800718:	a2dff0ef          	jal	ra,800144 <waitpid>
  ...
  800732:	a13ff0ef          	jal	ra,800144 <waitpid>
  800736:	c529                	beqz	a0,800780 <main+0xa4>
  800738:	a05ff0ef          	jal	ra,80013c <wait>
  ...
  8007c4:	9dfff0ef          	jal	ra,8001a2 <cprintf>
  8007c8:	981ff0ef          	jal	ra,800148 <yield>
  8007cc:	97dff0ef          	jal	ra,800148 <yield>
  8007d0:	979ff0ef          	jal	ra,800148 <yield>
  8007d4:	975ff0ef          	jal	ra,800148 <yield>
  8007d8:	971ff0ef          	jal	ra,800148 <yield>
  8007dc:	96dff0ef          	jal	ra,800148 <yield>
  8007e0:	969ff0ef          	jal	ra,800148 <yield>
  8007e4:	00001797          	auipc	a5,0x1
  8007e8:	81c78793          	addi	a5,a5,-2020 # 801000 <magic>
  8007ec:	4388                	lw	a0,0(a5)
  8007ee:	935ff0ef          	jal	ra,800122 <exit>
