...
0000000000800020 <__warn>:
  ...
  80004a:	0c8000ef          	jal	ra,800112 <vcprintf>
  80004e:	00000517          	auipc	a0,0x0
  800052:	6aa50513          	addi	a0,a0,1706 # 8006f8 <main+0x86>
...
00000000008000cc <exit>:
  ...
  8000d0:	fcbff0ef          	jal	ra,80009a <sys_exit>
  8000d4:	00000517          	auipc	a0,0x0
  8000d8:	5ec50513          	addi	a0,a0,1516 # 8006c0 <main+0x4e>
  8000dc:	05c000ef          	jal	ra,800138 <cprintf>
  8000e0:	a001                	j	8000e0 <exit+0x14>

00000000008000e2 <_start>:
  8000e2:	0d4000ef          	jal	ra,8001b6 <umain>
  8000e6:	a001                	j	8000e6 <_start+0x4>

00000000008000e8 <open>:
  8000e8:	1582                	slli	a1,a1,0x20
  8000ea:	9181                	srli	a1,a1,0x20
  8000ec:	fbfff06f          	j	8000aa <sys_open>

00000000008000f0 <close>:
  8000f0:	fc7ff06f          	j	8000b6 <sys_close>

00000000008000f4 <dup2>:
  8000f4:	fcdff06f          	j	8000c0 <sys_dup>
...
0000000000800112 <vcprintf>:
  ...
  800124:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6241>
  800128:	ec06                	sd	ra,24(sp)
  80012a:	c602                	sw	zero,12(sp)
  80012c:	19a000ef          	jal	ra,8002c6 <vprintfmt>
...
0000000000800138 <cprintf>:
  ...
  800148:	86aa                	mv	a3,a0
  80014a:	0050                	addi	a2,sp,4
  80014c:	00000517          	auipc	a0,0x0
  800150:	fac50513          	addi	a0,a0,-84 # 8000f8 <cputch>
  800154:	871a                	mv	a4,t1
  800156:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6241>
  ...
  800166:	160000ef          	jal	ra,8002c6 <vprintfmt>
...
0000000000800172 <initfd>:
  ...
  800182:	f67ff0ef          	jal	ra,8000e8 <open>
...
0000000000800672 <main>:
  ...
  800678:	a55ff0ef          	jal	ra,8000cc <exit>
