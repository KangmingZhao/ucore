...
0000000000800020 <__panic>:
  ...
  800042:	180000ef          	jal	ra,8001c2 <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	152000ef          	jal	ra,80019c <vcprintf>
  80004e:	00001517          	auipc	a0,0x1
  800052:	8f250513          	addi	a0,a0,-1806 # 800940 <main+0x232>
  800056:	16c000ef          	jal	ra,8001c2 <cprintf>
  80005a:	5559                	li	a0,-10
  80005c:	0de000ef          	jal	ra,80013a <exit>
...
0000000000800060 <__warn>:
  ...
  800082:	140000ef          	jal	ra,8001c2 <cprintf>
  800086:	65a2                	ld	a1,8(sp)
  800088:	8522                	mv	a0,s0
  80008a:	112000ef          	jal	ra,80019c <vcprintf>
  80008e:	00001517          	auipc	a0,0x1
  800092:	8b250513          	addi	a0,a0,-1870 # 800940 <main+0x232>
  800096:	12c000ef          	jal	ra,8001c2 <cprintf>
...
000000000080013a <exit>:
  ...
  80013e:	f9dff0ef          	jal	ra,8000da <sys_exit>
  800142:	00000517          	auipc	a0,0x0
  800146:	7c650513          	addi	a0,a0,1990 # 800908 <main+0x1fa>
  80014a:	078000ef          	jal	ra,8001c2 <cprintf>
  80014e:	a001                	j	80014e <exit+0x14>

0000000000800150 <fork>:
  800150:	f93ff06f          	j	8000e2 <sys_fork>

0000000000800154 <waitpid>:
  800154:	f95ff06f          	j	8000e8 <sys_wait>

0000000000800158 <kill>:
  800158:	f9bff06f          	j	8000f2 <sys_kill>

000000000080015c <getpid>:
  80015c:	f9fff06f          	j	8000fa <sys_getpid>

0000000000800160 <gettime_msec>:
  800160:	fb3ff06f          	j	800112 <sys_gettime>

0000000000800164 <lab6_set_priority>:
  800164:	1502                	slli	a0,a0,0x20
  800166:	9101                	srli	a0,a0,0x20
  800168:	fa1ff06f          	j	800108 <sys_lab6_set_priority>

000000000080016c <_start>:
  80016c:	0d4000ef          	jal	ra,800240 <umain>
  800170:	a001                	j	800170 <_start+0x4>

0000000000800172 <open>:
  800172:	1582                	slli	a1,a1,0x20
  800174:	9181                	srli	a1,a1,0x20
  800176:	fa3ff06f          	j	800118 <sys_open>

000000000080017a <close>:
  80017a:	fabff06f          	j	800124 <sys_close>

000000000080017e <dup2>:
  80017e:	fb1ff06f          	j	80012e <sys_dup>

0000000000800182 <cputch>:
  800182:	1141                	addi	sp,sp,-16
  800184:	e022                	sd	s0,0(sp)
  800186:	e406                	sd	ra,8(sp)
  800188:	842e                	mv	s0,a1
  80018a:	f77ff0ef          	jal	ra,800100 <sys_putc>
  80018e:	401c                	lw	a5,0(s0)
  800190:	60a2                	ld	ra,8(sp)
  800192:	2785                	addiw	a5,a5,1
  800194:	c01c                	sw	a5,0(s0)
  800196:	6402                	ld	s0,0(sp)
  800198:	0141                	addi	sp,sp,16
  80019a:	8082                	ret

000000000080019c <vcprintf>:
  80019c:	1101                	addi	sp,sp,-32
  80019e:	872e                	mv	a4,a1
  8001a0:	75dd                	lui	a1,0xffff7
  8001a2:	86aa                	mv	a3,a0
  8001a4:	0070                	addi	a2,sp,12
  8001a6:	00000517          	auipc	a0,0x0
  8001aa:	fdc50513          	addi	a0,a0,-36 # 800182 <cputch>
  8001ae:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <pids+0xffffffffff7f5aa9>
  8001b2:	ec06                	sd	ra,24(sp)
  8001b4:	c602                	sw	zero,12(sp)
  8001b6:	1ac000ef          	jal	ra,800362 <vprintfmt>
  8001ba:	60e2                	ld	ra,24(sp)
  8001bc:	4532                	lw	a0,12(sp)
  8001be:	6105                	addi	sp,sp,32
  8001c0:	8082                	ret

00000000008001c2 <cprintf>:
  8001c2:	711d                	addi	sp,sp,-96
  8001c4:	02810313          	addi	t1,sp,40
  8001c8:	f42e                	sd	a1,40(sp)
  8001ca:	75dd                	lui	a1,0xffff7
  8001cc:	f832                	sd	a2,48(sp)
  8001ce:	fc36                	sd	a3,56(sp)
  8001d0:	e0ba                	sd	a4,64(sp)
  8001d2:	86aa                	mv	a3,a0
  8001d4:	0050                	addi	a2,sp,4
  8001d6:	00000517          	auipc	a0,0x0
  8001da:	fac50513          	addi	a0,a0,-84 # 800182 <cputch>
  8001de:	871a                	mv	a4,t1
  8001e0:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <pids+0xffffffffff7f5aa9>
  8001e4:	ec06                	sd	ra,24(sp)
  8001e6:	e4be                	sd	a5,72(sp)
  8001e8:	e8c2                	sd	a6,80(sp)
  8001ea:	ecc6                	sd	a7,88(sp)
  8001ec:	e41a                	sd	t1,8(sp)
  8001ee:	c202                	sw	zero,4(sp)
  8001f0:	172000ef          	jal	ra,800362 <vprintfmt>
  8001f4:	60e2                	ld	ra,24(sp)
  8001f6:	4512                	lw	a0,4(sp)
  8001f8:	6125                	addi	sp,sp,96
  8001fa:	8082                	ret
...
00000000008001fc <initfd>:
  ...
  80020c:	f67ff0ef          	jal	ra,800172 <open>
  ...
  800228:	f53ff0ef          	jal	ra,80017a <close>
  80022c:	85a6                	mv	a1,s1
  80022e:	8522                	mv	a0,s0
  800230:	f4fff0ef          	jal	ra,80017e <dup2>
  800234:	84aa                	mv	s1,a0
  800236:	8522                	mv	a0,s0
  800238:	f43ff0ef          	jal	ra,80017a <close>
...
0000000000800240 <umain>:
  ...
  80027c:	ebfff0ef          	jal	ra,80013a <exit>
  ...
  800294:	dcdff0ef          	jal	ra,800060 <__warn>
  ...
  8002ae:	db3ff0ef          	jal	ra,800060 <__warn>
...
000000000080070e <main>:
  ...
  800744:	a21ff0ef          	jal	ra,800164 <lab6_set_priority>
  800748:	89d6                	mv	s3,s5
  80074a:	84ca                	mv	s1,s2
  80074c:	4401                	li	s0,0
  80074e:	4a15                	li	s4,5
  800750:	0009a023          	sw	zero,0(s3)
  800754:	9fdff0ef          	jal	ra,800150 <fork>
  ...
  80077a:	a49ff0ef          	jal	ra,8001c2 <cprintf>
  ...
  800838:	92dff0ef          	jal	ra,800164 <lab6_set_priority>
  ...
  80086e:	8f3ff0ef          	jal	ra,800160 <gettime_msec>
  800872:	0005099b          	sext.w	s3,a0
  800876:	fd3959e3          	ble	s3,s2,800848 <main+0x13a>
  80087a:	8e3ff0ef          	jal	ra,80015c <getpid>
  ...
  80088c:	937ff0ef          	jal	ra,8001c2 <cprintf>
  800890:	4008                	lw	a0,0(s0)
  800892:	8a9ff0ef          	jal	ra,80013a <exit>
  ...
  8008a6:	8b3ff0ef          	jal	ra,800158 <kill>
