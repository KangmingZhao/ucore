...
0000000000800020 <__panic>:
  ...
  800042:	16e000ef          	jal	ra,8001b0 <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	140000ef          	jal	ra,80018a <vcprintf>
  80004e:	00001517          	auipc	a0,0x1
  800052:	cda50513          	addi	a0,a0,-806 # 800d28 <error_string+0x2e0>
  800056:	15a000ef          	jal	ra,8001b0 <cprintf>
  80005a:	5559                	li	a0,-10
  80005c:	0d4000ef          	jal	ra,800130 <exit>
...
0000000000800130 <exit>:
  ...
  800134:	fa7ff0ef          	jal	ra,8000da <sys_exit>
  800138:	00000517          	auipc	a0,0x0
  80013c:	73850513          	addi	a0,a0,1848 # 800870 <main+0xf8>
  800140:	070000ef          	jal	ra,8001b0 <cprintf>
  800144:	a001                	j	800144 <exit+0x14>

0000000000800146 <fork>:
  800146:	f9dff06f          	j	8000e2 <sys_fork>

000000000080014a <waitpid>:
  80014a:	f9fff06f          	j	8000e8 <sys_wait>

000000000080014e <yield>:
  80014e:	fa5ff06f          	j	8000f2 <sys_yield>

0000000000800152 <kill>:
  800152:	fa7ff06f          	j	8000f8 <sys_kill>

0000000000800156 <getpid>:
  800156:	fabff06f          	j	800100 <sys_getpid>

000000000080015a <_start>:
  80015a:	0d4000ef          	jal	ra,80022e <umain>
  80015e:	a001                	j	80015e <_start+0x4>

0000000000800160 <open>:
  800160:	1582                	slli	a1,a1,0x20
  800162:	9181                	srli	a1,a1,0x20
  800164:	fabff06f          	j	80010e <sys_open>

0000000000800168 <close>:
  800168:	fb3ff06f          	j	80011a <sys_close>

000000000080016c <dup2>:
  80016c:	fb9ff06f          	j	800124 <sys_dup>

0000000000800170 <cputch>:
  800170:	1141                	addi	sp,sp,-16
  800172:	e022                	sd	s0,0(sp)
  800174:	e406                	sd	ra,8(sp)
  800176:	842e                	mv	s0,a1
  800178:	f8fff0ef          	jal	ra,800106 <sys_putc>
  80017c:	401c                	lw	a5,0(s0)
  80017e:	60a2                	ld	ra,8(sp)
  800180:	2785                	addiw	a5,a5,1
  800182:	c01c                	sw	a5,0(s0)
  800184:	6402                	ld	s0,0(sp)
  800186:	0141                	addi	sp,sp,16
  800188:	8082                	ret

000000000080018a <vcprintf>:
  80018a:	1101                	addi	sp,sp,-32
  80018c:	872e                	mv	a4,a1
  80018e:	75dd                	lui	a1,0xffff7
  800190:	86aa                	mv	a3,a0
  800192:	0070                	addi	a2,sp,12
  800194:	00000517          	auipc	a0,0x0
  800198:	fdc50513          	addi	a0,a0,-36 # 800170 <cputch>
  80019c:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <pid1+0xffffffffff7f5ad1>
  8001a0:	ec06                	sd	ra,24(sp)
  8001a2:	c602                	sw	zero,12(sp)
  8001a4:	19a000ef          	jal	ra,80033e <vprintfmt>
  8001a8:	60e2                	ld	ra,24(sp)
  8001aa:	4532                	lw	a0,12(sp)
  8001ac:	6105                	addi	sp,sp,32
  8001ae:	8082                	ret

00000000008001b0 <cprintf>:
  8001b0:	711d                	addi	sp,sp,-96
  8001b2:	02810313          	addi	t1,sp,40
  8001b6:	f42e                	sd	a1,40(sp)
  8001b8:	75dd                	lui	a1,0xffff7
  8001ba:	f832                	sd	a2,48(sp)
  8001bc:	fc36                	sd	a3,56(sp)
  8001be:	e0ba                	sd	a4,64(sp)
  8001c0:	86aa                	mv	a3,a0
  8001c2:	0050                	addi	a2,sp,4
  8001c4:	00000517          	auipc	a0,0x0
  8001c8:	fac50513          	addi	a0,a0,-84 # 800170 <cputch>
  8001cc:	871a                	mv	a4,t1
  8001ce:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <pid1+0xffffffffff7f5ad1>
  8001d2:	ec06                	sd	ra,24(sp)
  8001d4:	e4be                	sd	a5,72(sp)
  8001d6:	e8c2                	sd	a6,80(sp)
  8001d8:	ecc6                	sd	a7,88(sp)
  8001da:	e41a                	sd	t1,8(sp)
  8001dc:	c202                	sw	zero,4(sp)
  8001de:	160000ef          	jal	ra,80033e <vprintfmt>
  8001e2:	60e2                	ld	ra,24(sp)
  8001e4:	4512                	lw	a0,4(sp)
  8001e6:	6125                	addi	sp,sp,96
  8001e8:	8082                	ret
...
00000000008001ea <initfd>:
  ...
  8001fa:	f67ff0ef          	jal	ra,800160 <open>
  ...
  800216:	f53ff0ef          	jal	ra,800168 <close>
  80021a:	85a6                	mv	a1,s1
  80021c:	8522                	mv	a0,s0
  80021e:	f4fff0ef          	jal	ra,80016c <dup2>
  800222:	84aa                	mv	s1,a0
  800224:	8522                	mv	a0,s0
  800226:	f43ff0ef          	jal	ra,800168 <close>
...
000000000080022e <umain>:
  ...
  80026a:	ec7ff0ef          	jal	ra,800130 <exit>
  ...
  800282:	ddfff0ef          	jal	ra,800060 <__warn>
  ...
  80029c:	dc5ff0ef          	jal	ra,800060 <__warn>
...
00000000008006ea <do_yield>:
  ...
  8006ee:	a61ff0ef          	jal	ra,80014e <yield>
  8006f2:	a5dff0ef          	jal	ra,80014e <yield>
  8006f6:	a59ff0ef          	jal	ra,80014e <yield>
  8006fa:	a55ff0ef          	jal	ra,80014e <yield>
  8006fe:	a51ff0ef          	jal	ra,80014e <yield>
  800702:	60a2                	ld	ra,8(sp)
  800704:	0141                	addi	sp,sp,16
  800706:	a49ff06f          	j	80014e <yield>
...
000000000080070a <loop>:
  ...
  800716:	a9bff0ef          	jal	ra,8001b0 <cprintf>
...
000000000080071c <work>:
  ...
  800728:	a89ff0ef          	jal	ra,8001b0 <cprintf>
  ...
  80073a:	a19ff0ef          	jal	ra,800152 <kill>
  ...
  800748:	a69ff0ef          	jal	ra,8001b0 <cprintf>
...
0000000000800778 <main>:
  ...
  80079c:	9abff0ef          	jal	ra,800146 <fork>
  ...
  8007be:	9f3ff0ef          	jal	ra,8001b0 <cprintf>
  8007c2:	4008                	lw	a0,0(s0)
  8007c4:	4581                	li	a1,0
  8007c6:	985ff0ef          	jal	ra,80014a <waitpid>
  ...
  80080a:	949ff0ef          	jal	ra,800152 <kill>
