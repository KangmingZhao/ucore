...
0000000000800020 <__panic>:
  ...
  800042:	168000ef          	jal	ra,8001aa <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	13a000ef          	jal	ra,800184 <vcprintf>
  80004e:	00000517          	auipc	a0,0x0
  800052:	7b250513          	addi	a0,a0,1970 # 800800 <main+0xe6>
  800056:	154000ef          	jal	ra,8001aa <cprintf>
...
0000000000800060 <__warn>:
  ...
  800082:	128000ef          	jal	ra,8001aa <cprintf>
  800086:	65a2                	ld	a1,8(sp)
  800088:	8522                	mv	a0,s0
  80008a:	0fa000ef          	jal	ra,800184 <vcprintf>
  80008e:	00000517          	auipc	a0,0x0
  800092:	77250513          	addi	a0,a0,1906 # 800800 <main+0xe6>
  800096:	114000ef          	jal	ra,8001aa <cprintf>
...
000000000080012a <exit>:
  ...
  800136:	69650513          	addi	a0,a0,1686 # 8007c8 <main+0xae>
  80013a:	070000ef          	jal	ra,8001aa <cprintf>
...
0000000000800148 <gettime_msec>:
  800148:	fbbff06f          	j	800102 <sys_gettime>

000000000080014c <sleep>:
  80014c:	1502                	slli	a0,a0,0x20
  80014e:	9101                	srli	a0,a0,0x20
  800150:	fabff06f          	j	8000fa <sys_sleep>

0000000000800154 <_start>:
  800154:	0d4000ef          	jal	ra,800228 <umain>
  800158:	a001                	j	800158 <_start+0x4>

000000000080015a <open>:
  80015a:	1582                	slli	a1,a1,0x20
  80015c:	9181                	srli	a1,a1,0x20
  80015e:	fabff06f          	j	800108 <sys_open>

0000000000800162 <close>:
  800162:	fb3ff06f          	j	800114 <sys_close>

0000000000800166 <dup2>:
  800166:	fb9ff06f          	j	80011e <sys_dup>

000000000080016a <cputch>:
  80016a:	1141                	addi	sp,sp,-16
  80016c:	e022                	sd	s0,0(sp)
  80016e:	e406                	sd	ra,8(sp)
  800170:	842e                	mv	s0,a1
  800172:	f81ff0ef          	jal	ra,8000f2 <sys_putc>
  800176:	401c                	lw	a5,0(s0)
  800178:	60a2                	ld	ra,8(sp)
  80017a:	2785                	addiw	a5,a5,1
  80017c:	c01c                	sw	a5,0(s0)
  80017e:	6402                	ld	s0,0(sp)
  800180:	0141                	addi	sp,sp,16
  800182:	8082                	ret
...
0000000000800184 <vcprintf>:
  ...
  800192:	fdc50513          	addi	a0,a0,-36 # 80016a <cputch>
  800196:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6139>
  80019a:	ec06                	sd	ra,24(sp)
  80019c:	c602                	sw	zero,12(sp)
  80019e:	19a000ef          	jal	ra,800338 <vprintfmt>
...
00000000008001aa <cprintf>:
  ...
  8001c2:	fac50513          	addi	a0,a0,-84 # 80016a <cputch>
  8001c6:	871a                	mv	a4,t1
  8001c8:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6139>
  8001cc:	ec06                	sd	ra,24(sp)
  8001ce:	e4be                	sd	a5,72(sp)
  8001d0:	e8c2                	sd	a6,80(sp)
  8001d2:	ecc6                	sd	a7,88(sp)
  8001d4:	e41a                	sd	t1,8(sp)
  8001d6:	c202                	sw	zero,4(sp)
  8001d8:	160000ef          	jal	ra,800338 <vprintfmt>
...
00000000008001e4 <initfd>:
  ...
  8001f4:	f67ff0ef          	jal	ra,80015a <open>
  ...
  800210:	f53ff0ef          	jal	ra,800162 <close>
  800214:	85a6                	mv	a1,s1
  800216:	8522                	mv	a0,s0
  800218:	f4fff0ef          	jal	ra,800166 <dup2>
  80021c:	84aa                	mv	s1,a0
  80021e:	8522                	mv	a0,s0
  800220:	f43ff0ef          	jal	ra,800162 <close>
...
0000000000800228 <umain>:
  ...
  800264:	ec7ff0ef          	jal	ra,80012a <exit>
  ...
  800296:	dcbff0ef          	jal	ra,800060 <__warn>
