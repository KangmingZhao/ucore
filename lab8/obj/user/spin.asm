...
0000000000800020 <__panic>:
  ...
  800042:	164000ef          	jal	ra,8001a6 <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	136000ef          	jal	ra,800180 <vcprintf>
  80004e:	00000517          	auipc	a0,0x0
  800052:	7da50513          	addi	a0,a0,2010 # 800828 <main+0x148>
  800056:	150000ef          	jal	ra,8001a6 <cprintf>
  80005a:	5559                	li	a0,-10
  80005c:	0ce000ef          	jal	ra,80012a <exit>
...
0000000000800060 <__warn>:
  ...
  800082:	124000ef          	jal	ra,8001a6 <cprintf>
  800086:	65a2                	ld	a1,8(sp)
  800088:	8522                	mv	a0,s0
  80008a:	0f6000ef          	jal	ra,800180 <vcprintf>
  80008e:	00000517          	auipc	a0,0x0
  800092:	79a50513          	addi	a0,a0,1946 # 800828 <main+0x148>
  800096:	110000ef          	jal	ra,8001a6 <cprintf>
...
000000000080012a <exit>:
  ...
  80012e:	fadff0ef          	jal	ra,8000da <sys_exit>
  800132:	00000517          	auipc	a0,0x0
  800136:	6be50513          	addi	a0,a0,1726 # 8007f0 <main+0x110>
  80013a:	06c000ef          	jal	ra,8001a6 <cprintf>
  80013e:	a001                	j	80013e <exit+0x14>

0000000000800140 <fork>:
  800140:	fa3ff06f          	j	8000e2 <sys_fork>

0000000000800144 <waitpid>:
  800144:	fa5ff06f          	j	8000e8 <sys_wait>

0000000000800148 <yield>:
  800148:	fabff06f          	j	8000f2 <sys_yield>

000000000080014c <kill>:
  80014c:	fadff06f          	j	8000f8 <sys_kill>

0000000000800150 <_start>:
  800150:	0d4000ef          	jal	ra,800224 <umain>
  800154:	a001                	j	800154 <_start+0x4>

0000000000800156 <open>:
  800156:	1582                	slli	a1,a1,0x20
  800158:	9181                	srli	a1,a1,0x20
  80015a:	fafff06f          	j	800108 <sys_open>

000000000080015e <close>:
  80015e:	fb7ff06f          	j	800114 <sys_close>

0000000000800162 <dup2>:
  800162:	fbdff06f          	j	80011e <sys_dup>

0000000000800166 <cputch>:
  800166:	1141                	addi	sp,sp,-16
  800168:	e022                	sd	s0,0(sp)
  80016a:	e406                	sd	ra,8(sp)
  80016c:	842e                	mv	s0,a1
  80016e:	f93ff0ef          	jal	ra,800100 <sys_putc>
  800172:	401c                	lw	a5,0(s0)
  800174:	60a2                	ld	ra,8(sp)
  800176:	2785                	addiw	a5,a5,1
  800178:	c01c                	sw	a5,0(s0)
  80017a:	6402                	ld	s0,0(sp)
  80017c:	0141                	addi	sp,sp,16
  80017e:	8082                	ret

0000000000800180 <vcprintf>:
  800180:	1101                	addi	sp,sp,-32
  800182:	872e                	mv	a4,a1
  800184:	75dd                	lui	a1,0xffff7
  800186:	86aa                	mv	a3,a0
  800188:	0070                	addi	a2,sp,12
  80018a:	00000517          	auipc	a0,0x0
  80018e:	fdc50513          	addi	a0,a0,-36 # 800166 <cputch>
  800192:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6111>
  800196:	ec06                	sd	ra,24(sp)
  800198:	c602                	sw	zero,12(sp)
  80019a:	19a000ef          	jal	ra,800334 <vprintfmt>
  80019e:	60e2                	ld	ra,24(sp)
  8001a0:	4532                	lw	a0,12(sp)
  8001a2:	6105                	addi	sp,sp,32
  8001a4:	8082                	ret

00000000008001a6 <cprintf>:
  8001a6:	711d                	addi	sp,sp,-96
  8001a8:	02810313          	addi	t1,sp,40
  8001ac:	f42e                	sd	a1,40(sp)
  8001ae:	75dd                	lui	a1,0xffff7
  8001b0:	f832                	sd	a2,48(sp)
  8001b2:	fc36                	sd	a3,56(sp)
  8001b4:	e0ba                	sd	a4,64(sp)
  8001b6:	86aa                	mv	a3,a0
  8001b8:	0050                	addi	a2,sp,4
  8001ba:	00000517          	auipc	a0,0x0
  8001be:	fac50513          	addi	a0,a0,-84 # 800166 <cputch>
  8001c2:	871a                	mv	a4,t1
  8001c4:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6111>
  8001c8:	ec06                	sd	ra,24(sp)
  8001ca:	e4be                	sd	a5,72(sp)
  8001cc:	e8c2                	sd	a6,80(sp)
  8001ce:	ecc6                	sd	a7,88(sp)
  8001d0:	e41a                	sd	t1,8(sp)
  8001d2:	c202                	sw	zero,4(sp)
  8001d4:	160000ef          	jal	ra,800334 <vprintfmt>
  8001d8:	60e2                	ld	ra,24(sp)
  8001da:	4512                	lw	a0,4(sp)
  8001dc:	6125                	addi	sp,sp,96
  8001de:	8082                	ret
...
00000000008001e0 <initfd>:
  ...
  8001f0:	f67ff0ef          	jal	ra,800156 <open>
  ...
  80020c:	f53ff0ef          	jal	ra,80015e <close>
  800210:	85a6                	mv	a1,s1
  800212:	8522                	mv	a0,s0
  800214:	f4fff0ef          	jal	ra,800162 <dup2>
  800218:	84aa                	mv	s1,a0
  80021a:	8522                	mv	a0,s0
  80021c:	f43ff0ef          	jal	ra,80015e <close>
...
0000000000800224 <umain>:
  ...
  800260:	ecbff0ef          	jal	ra,80012a <exit>
  ...
  800278:	de9ff0ef          	jal	ra,800060 <__warn>
  ...
  800292:	dcfff0ef          	jal	ra,800060 <__warn>
...
00000000008006e0 <main>:
  ...
  8006ee:	ab9ff0ef          	jal	ra,8001a6 <cprintf>
  8006f2:	a4fff0ef          	jal	ra,800140 <fork>
  ...
  800700:	aa7ff0ef          	jal	ra,8001a6 <cprintf>
  ...
  800710:	a97ff0ef          	jal	ra,8001a6 <cprintf>
  800714:	a35ff0ef          	jal	ra,800148 <yield>
  800718:	a31ff0ef          	jal	ra,800148 <yield>
  80071c:	a2dff0ef          	jal	ra,800148 <yield>
  800720:	00000517          	auipc	a0,0x0
  800724:	5f050513          	addi	a0,a0,1520 # 800d10 <error_string+0x348>
  800728:	a7fff0ef          	jal	ra,8001a6 <cprintf>
  80072c:	8522                	mv	a0,s0
  80072e:	a1fff0ef          	jal	ra,80014c <kill>
  ...
  80073e:	a69ff0ef          	jal	ra,8001a6 <cprintf>
  800742:	4581                	li	a1,0
  800744:	8522                	mv	a0,s0
  800746:	9ffff0ef          	jal	ra,800144 <waitpid>
