...
0000000000800020 <__warn>:
  ...
  800042:	114000ef          	jal	ra,800156 <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	0e6000ef          	jal	ra,800130 <vcprintf>
  80004e:	00000517          	auipc	a0,0x0
  800052:	7ea50513          	addi	a0,a0,2026 # 800838 <main+0x92>
  800056:	100000ef          	jal	ra,800156 <cprintf>
...
00000000008000de <exit>:
  ...
  8000e2:	fb9ff0ef          	jal	ra,80009a <sys_exit>
  8000e6:	00000517          	auipc	a0,0x0
  8000ea:	71a50513          	addi	a0,a0,1818 # 800800 <main+0x5a>
  8000ee:	068000ef          	jal	ra,800156 <cprintf>
  8000f2:	a001                	j	8000f2 <exit+0x14>

00000000008000f4 <fork>:
  8000f4:	fafff06f          	j	8000a2 <sys_fork>

00000000008000f8 <yield>:
  8000f8:	fb1ff06f          	j	8000a8 <sys_yield>

00000000008000fc <getpid>:
  8000fc:	fb3ff06f          	j	8000ae <sys_getpid>

0000000000800100 <_start>:
  800100:	0d4000ef          	jal	ra,8001d4 <umain>
  800104:	a001                	j	800104 <_start+0x4>

0000000000800106 <open>:
  800106:	1582                	slli	a1,a1,0x20
  800108:	9181                	srli	a1,a1,0x20
  80010a:	fb3ff06f          	j	8000bc <sys_open>

000000000080010e <close>:
  80010e:	fbbff06f          	j	8000c8 <sys_close>

0000000000800112 <dup2>:
  800112:	fc1ff06f          	j	8000d2 <sys_dup>
...
0000000000800116 <cputch>:
  ...
  80011e:	f97ff0ef          	jal	ra,8000b4 <sys_putc>
...
0000000000800130 <vcprintf>:
  ...
  800142:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6101>
  800146:	ec06                	sd	ra,24(sp)
  800148:	c602                	sw	zero,12(sp)
  80014a:	1d2000ef          	jal	ra,80031c <vprintfmt>
...
0000000000800156 <cprintf>:
  ...
  80015c:	f42e                	sd	a1,40(sp)
  80015e:	75dd                	lui	a1,0xffff7
  800160:	f832                	sd	a2,48(sp)
  800162:	fc36                	sd	a3,56(sp)
  800164:	e0ba                	sd	a4,64(sp)
  800166:	86aa                	mv	a3,a0
  800168:	0050                	addi	a2,sp,4
  80016a:	00000517          	auipc	a0,0x0
  80016e:	fac50513          	addi	a0,a0,-84 # 800116 <cputch>
  800172:	871a                	mv	a4,t1
  800174:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6101>
  800178:	ec06                	sd	ra,24(sp)
  80017a:	e4be                	sd	a5,72(sp)
  80017c:	e8c2                	sd	a6,80(sp)
  80017e:	ecc6                	sd	a7,88(sp)
  800180:	e41a                	sd	t1,8(sp)
  800182:	c202                	sw	zero,4(sp)
  800184:	198000ef          	jal	ra,80031c <vprintfmt>
  800188:	60e2                	ld	ra,24(sp)
  80018a:	4512                	lw	a0,4(sp)
  80018c:	6125                	addi	sp,sp,96
  80018e:	8082                	ret
...
0000000000800190 <initfd>:
  ...
  8001a0:	f67ff0ef          	jal	ra,800106 <open>
  ...
  8001bc:	f53ff0ef          	jal	ra,80010e <close>
  8001c0:	85a6                	mv	a1,s1
  8001c2:	8522                	mv	a0,s0
  8001c4:	f4fff0ef          	jal	ra,800112 <dup2>
  8001c8:	84aa                	mv	s1,a0
  8001ca:	8522                	mv	a0,s0
  8001cc:	f43ff0ef          	jal	ra,80010e <close>
...
00000000008001d4 <umain>:
  ...
  800210:	ecfff0ef          	jal	ra,8000de <exit>
  ...
  800228:	df9ff0ef          	jal	ra,800020 <__warn>
  ...
  800242:	ddfff0ef          	jal	ra,800020 <__warn>
...
0000000000800726 <forktree>:
  ...
  80072e:	9cfff0ef          	jal	ra,8000fc <getpid>
  ...
  80073e:	a19ff0ef          	jal	ra,800156 <cprintf>
...
000000000080075c <forkchild>:
  ...
  800790:	965ff0ef          	jal	ra,8000f4 <fork>
  800794:	fd79                	bnez	a0,800772 <forkchild+0x16>
  800796:	0028                	addi	a0,sp,8
  800798:	f8fff0ef          	jal	ra,800726 <forktree>
  80079c:	95dff0ef          	jal	ra,8000f8 <yield>
  8007a0:	4501                	li	a0,0
  8007a2:	93dff0ef          	jal	ra,8000de <exit>
