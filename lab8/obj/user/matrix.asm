...
0000000000800020 <__panic>:
  ...
  800042:	172000ef          	jal	ra,8001b4 <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	144000ef          	jal	ra,80018e <vcprintf>
  80004e:	00001517          	auipc	a0,0x1
  800052:	96250513          	addi	a0,a0,-1694 # 8009b0 <main+0x146>
  800056:	15e000ef          	jal	ra,8001b4 <cprintf>
...
0000000000800060 <__warn>:
  ...
  800082:	132000ef          	jal	ra,8001b4 <cprintf>
  800086:	65a2                	ld	a1,8(sp)
  800088:	8522                	mv	a0,s0
  80008a:	104000ef          	jal	ra,80018e <vcprintf>
  80008e:	00001517          	auipc	a0,0x1
  800092:	92250513          	addi	a0,a0,-1758 # 8009b0 <main+0x146>
  800096:	11e000ef          	jal	ra,8001b4 <cprintf>
...
0000000000800130 <exit>:
  ...
  800138:	00001517          	auipc	a0,0x1
  80013c:	84050513          	addi	a0,a0,-1984 # 800978 <main+0x10e>
  800140:	074000ef          	jal	ra,8001b4 <cprintf>
...
000000000080014a <wait>:
  80014a:	4581                	li	a1,0
  80014c:	4501                	li	a0,0
  80014e:	f9bff06f          	j	8000e8 <sys_wait>

0000000000800152 <yield>:
  800152:	fa1ff06f          	j	8000f2 <sys_yield>

0000000000800156 <kill>:
  800156:	fa3ff06f          	j	8000f8 <sys_kill>

000000000080015a <getpid>:
  80015a:	fa7ff06f          	j	800100 <sys_getpid>

000000000080015e <_start>:
  80015e:	0d4000ef          	jal	ra,800232 <umain>
  800162:	a001                	j	800162 <_start+0x4>

0000000000800164 <open>:
  800164:	1582                	slli	a1,a1,0x20
  800166:	9181                	srli	a1,a1,0x20
  800168:	fa7ff06f          	j	80010e <sys_open>

000000000080016c <close>:
  80016c:	fafff06f          	j	80011a <sys_close>

0000000000800170 <dup2>:
  800170:	fb5ff06f          	j	800124 <sys_dup>

0000000000800174 <cputch>:
  800174:	1141                	addi	sp,sp,-16
  800176:	e022                	sd	s0,0(sp)
  800178:	e406                	sd	ra,8(sp)
  80017a:	842e                	mv	s0,a1
  80017c:	f8bff0ef          	jal	ra,800106 <sys_putc>
  800180:	401c                	lw	a5,0(s0)
  800182:	60a2                	ld	ra,8(sp)
  800184:	2785                	addiw	a5,a5,1
  800186:	c01c                	sw	a5,0(s0)
  800188:	6402                	ld	s0,0(sp)
  80018a:	0141                	addi	sp,sp,16
  80018c:	8082                	ret

000000000080018e <vcprintf>:
  80018e:	1101                	addi	sp,sp,-32
  800190:	872e                	mv	a4,a1
  800192:	75dd                	lui	a1,0xffff7
  800194:	86aa                	mv	a3,a0
  800196:	0070                	addi	a2,sp,12
  800198:	00000517          	auipc	a0,0x0
  80019c:	fdc50513          	addi	a0,a0,-36 # 800174 <cputch>
  8001a0:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <matc+0xffffffffff7f57b1>
  8001a4:	ec06                	sd	ra,24(sp)
  8001a6:	c602                	sw	zero,12(sp)
  8001a8:	1ac000ef          	jal	ra,800354 <vprintfmt>
  8001ac:	60e2                	ld	ra,24(sp)
  8001ae:	4532                	lw	a0,12(sp)
  8001b0:	6105                	addi	sp,sp,32
  8001b2:	8082                	ret

00000000008001b4 <cprintf>:
  8001b4:	711d                	addi	sp,sp,-96
  8001b6:	02810313          	addi	t1,sp,40
  8001ba:	f42e                	sd	a1,40(sp)
  8001bc:	75dd                	lui	a1,0xffff7
  8001be:	f832                	sd	a2,48(sp)
  8001c0:	fc36                	sd	a3,56(sp)
  8001c2:	e0ba                	sd	a4,64(sp)
  8001c4:	86aa                	mv	a3,a0
  8001c6:	0050                	addi	a2,sp,4
  8001c8:	00000517          	auipc	a0,0x0
  8001cc:	fac50513          	addi	a0,a0,-84 # 800174 <cputch>
  8001d0:	871a                	mv	a4,t1
  8001d2:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <matc+0xffffffffff7f57b1>
  ...
  8001e2:	172000ef          	jal	ra,800354 <vprintfmt>
...
00000000008001ee <initfd>:
  ...
  8001fe:	f67ff0ef          	jal	ra,800164 <open>
  ...
  80021a:	f53ff0ef          	jal	ra,80016c <close>
  80021e:	85a6                	mv	a1,s1
  800220:	8522                	mv	a0,s0
  800222:	f4fff0ef          	jal	ra,800170 <dup2>
  800226:	84aa                	mv	s1,a0
  800228:	8522                	mv	a0,s0
  80022a:	f43ff0ef          	jal	ra,80016c <close>
...
0000000000800232 <umain>:
  ...
  80026e:	ec3ff0ef          	jal	ra,800130 <exit>
  ...
  8002a0:	dc1ff0ef          	jal	ra,800060 <__warn>
...
0000000000800744 <work>:
  ...
  80079c:	9b7ff0ef          	jal	ra,800152 <yield>
  8007a0:	9bbff0ef          	jal	ra,80015a <getpid>
  ...
  8007b0:	a05ff0ef          	jal	ra,8001b4 <cprintf>
  8007b4:	53fd                	li	t2,-1
  ...
  800852:	909ff0ef          	jal	ra,80015a <getpid>
  800856:	85aa                	mv	a1,a0
  800858:	00000517          	auipc	a0,0x0
  80085c:	64850513          	addi	a0,a0,1608 # 800ea0 <error_string+0x350>
  800860:	955ff0ef          	jal	ra,8001b4 <cprintf>
  800864:	4501                	li	a0,0
  800866:	8cbff0ef          	jal	ra,800130 <exit>
...
000000000080086a <main>:
  ...
  80088c:	8bbff0ef          	jal	ra,800146 <fork>
  ...
  8008a8:	90dff0ef          	jal	ra,8001b4 <cprintf>
  8008ac:	4455                	li	s0,21
  8008ae:	89dff0ef          	jal	ra,80014a <wait>
  ...
  8008c0:	8f5ff0ef          	jal	ra,8001b4 <cprintf>
