...
0000000000800020 <__panic>:
  ...
  800042:	1c8000ef          	jal	ra,80020a <cprintf>
  800046:	65a2                	ld	a1,8(sp)
  800048:	8522                	mv	a0,s0
  80004a:	19a000ef          	jal	ra,8001e4 <vcprintf>
  80004e:	00001517          	auipc	a0,0x1
  800052:	dba50513          	addi	a0,a0,-582 # 800e08 <main+0x142>
  800056:	1b4000ef          	jal	ra,80020a <cprintf>
  80005a:	5559                	li	a0,-10
  80005c:	0e8000ef          	jal	ra,800144 <exit>
...
0000000000800060 <__warn>:
  ...
  800082:	188000ef          	jal	ra,80020a <cprintf>
  800086:	65a2                	ld	a1,8(sp)
  800088:	8522                	mv	a0,s0
  80008a:	15a000ef          	jal	ra,8001e4 <vcprintf>
  80008e:	00001517          	auipc	a0,0x1
  800092:	d7a50513          	addi	a0,a0,-646 # 800e08 <main+0x142>
  800096:	174000ef          	jal	ra,80020a <cprintf>
...
0000000000800144 <exit>:
  ...
  800148:	f93ff0ef          	jal	ra,8000da <sys_exit>
  80014c:	00001517          	auipc	a0,0x1
  800150:	c8450513          	addi	a0,a0,-892 # 800dd0 <main+0x10a>
  800154:	0b6000ef          	jal	ra,80020a <cprintf>
  800158:	a001                	j	800158 <exit+0x14>

000000000080015a <fork>:
  80015a:	f89ff06f          	j	8000e2 <sys_fork>

000000000080015e <waitpid>:
  80015e:	f8bff06f          	j	8000e8 <sys_wait>

0000000000800162 <__exec>:
  800162:	619c                	ld	a5,0(a1)
  800164:	862e                	mv	a2,a1
  800166:	cf81                	beqz	a5,80017e <__exec+0x1c>
  800168:	00858793          	addi	a5,a1,8
  80016c:	4701                	li	a4,0
  80016e:	07a1                	addi	a5,a5,8
  800170:	ff87b683          	ld	a3,-8(a5)
  800174:	2705                	addiw	a4,a4,1
  800176:	fee5                	bnez	a3,80016e <__exec+0xc>
  800178:	85ba                	mv	a1,a4
  80017a:	f81ff06f          	j	8000fa <sys_exec>
  80017e:	4581                	li	a1,0
  800180:	f7bff06f          	j	8000fa <sys_exec>

0000000000800184 <_start>:
  800184:	178000ef          	jal	ra,8002fc <umain>
  800188:	a001                	j	800188 <_start+0x4>

000000000080018a <open>:
  80018a:	1582                	slli	a1,a1,0x20
  80018c:	9181                	srli	a1,a1,0x20
  80018e:	f79ff06f          	j	800106 <sys_open>

0000000000800192 <close>:
  800192:	f81ff06f          	j	800112 <sys_close>

0000000000800196 <read>:
  800196:	f87ff06f          	j	80011c <sys_read>

000000000080019a <write>:
  80019a:	f91ff06f          	j	80012a <sys_write>

000000000080019e <dup2>:
  80019e:	f9bff06f          	j	800138 <sys_dup>

00000000008001a2 <cputch>:
  8001a2:	1141                	addi	sp,sp,-16
  8001a4:	e022                	sd	s0,0(sp)
  8001a6:	e406                	sd	ra,8(sp)
  8001a8:	842e                	mv	s0,a1
  8001aa:	f49ff0ef          	jal	ra,8000f2 <sys_putc>
  8001ae:	401c                	lw	a5,0(s0)
  8001b0:	60a2                	ld	ra,8(sp)
  8001b2:	2785                	addiw	a5,a5,1
  8001b4:	c01c                	sw	a5,0(s0)
  8001b6:	6402                	ld	s0,0(sp)
  8001b8:	0141                	addi	sp,sp,16
  8001ba:	8082                	ret

00000000008001bc <fputch>:
  8001bc:	1101                	addi	sp,sp,-32
  8001be:	87b2                	mv	a5,a2
  8001c0:	e822                	sd	s0,16(sp)
  8001c2:	00a107a3          	sb	a0,15(sp)
  8001c6:	842e                	mv	s0,a1
  8001c8:	853e                	mv	a0,a5
  8001ca:	00f10593          	addi	a1,sp,15
  8001ce:	4605                	li	a2,1
  8001d0:	ec06                	sd	ra,24(sp)
  8001d2:	fc9ff0ef          	jal	ra,80019a <write>
  8001d6:	401c                	lw	a5,0(s0)
  8001d8:	60e2                	ld	ra,24(sp)
  8001da:	2785                	addiw	a5,a5,1
  8001dc:	c01c                	sw	a5,0(s0)
  8001de:	6442                	ld	s0,16(sp)
  8001e0:	6105                	addi	sp,sp,32
  8001e2:	8082                	ret

00000000008001e4 <vcprintf>:
  8001e4:	1101                	addi	sp,sp,-32
  8001e6:	872e                	mv	a4,a1
  8001e8:	75dd                	lui	a1,0xffff7
  8001ea:	86aa                	mv	a3,a0
  8001ec:	0070                	addi	a2,sp,12
  8001ee:	00000517          	auipc	a0,0x0
  8001f2:	fb450513          	addi	a0,a0,-76 # 8001a2 <cputch>
  8001f6:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <buffer.1212+0xffffffffff7f29d1>
  8001fa:	ec06                	sd	ra,24(sp)
  8001fc:	c602                	sw	zero,12(sp)
  8001fe:	282000ef          	jal	ra,800480 <vprintfmt>
  800202:	60e2                	ld	ra,24(sp)
  800204:	4532                	lw	a0,12(sp)
  800206:	6105                	addi	sp,sp,32
  800208:	8082                	ret

000000000080020a <cprintf>:
  80020a:	711d                	addi	sp,sp,-96
  80020c:	02810313          	addi	t1,sp,40
  800210:	f42e                	sd	a1,40(sp)
  800212:	75dd                	lui	a1,0xffff7
  800214:	f832                	sd	a2,48(sp)
  800216:	fc36                	sd	a3,56(sp)
  800218:	e0ba                	sd	a4,64(sp)
  80021a:	86aa                	mv	a3,a0
  80021c:	0050                	addi	a2,sp,4
  80021e:	00000517          	auipc	a0,0x0
  800222:	f8450513          	addi	a0,a0,-124 # 8001a2 <cputch>
  800226:	871a                	mv	a4,t1
  800228:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <buffer.1212+0xffffffffff7f29d1>
  80022c:	ec06                	sd	ra,24(sp)
  80022e:	e4be                	sd	a5,72(sp)
  800230:	e8c2                	sd	a6,80(sp)
  800232:	ecc6                	sd	a7,88(sp)
  800234:	e41a                	sd	t1,8(sp)
  800236:	c202                	sw	zero,4(sp)
  800238:	248000ef          	jal	ra,800480 <vprintfmt>
  80023c:	60e2                	ld	ra,24(sp)
  80023e:	4512                	lw	a0,4(sp)
  800240:	6125                	addi	sp,sp,96
  800242:	8082                	ret

0000000000800244 <cputs>:
  800244:	1101                	addi	sp,sp,-32
  800246:	e822                	sd	s0,16(sp)
  800248:	ec06                	sd	ra,24(sp)
  80024a:	e426                	sd	s1,8(sp)
  80024c:	842a                	mv	s0,a0
  80024e:	00054503          	lbu	a0,0(a0)
  800252:	c51d                	beqz	a0,800280 <cputs+0x3c>
  800254:	0405                	addi	s0,s0,1
  800256:	4485                	li	s1,1
  800258:	9c81                	subw	s1,s1,s0
  80025a:	e99ff0ef          	jal	ra,8000f2 <sys_putc>
  80025e:	008487bb          	addw	a5,s1,s0
  800262:	0405                	addi	s0,s0,1
  800264:	fff44503          	lbu	a0,-1(s0)
  800268:	f96d                	bnez	a0,80025a <cputs+0x16>
  80026a:	0017841b          	addiw	s0,a5,1
  80026e:	4529                	li	a0,10
  800270:	e83ff0ef          	jal	ra,8000f2 <sys_putc>
  800274:	8522                	mv	a0,s0
  800276:	60e2                	ld	ra,24(sp)
  800278:	6442                	ld	s0,16(sp)
  80027a:	64a2                	ld	s1,8(sp)
  80027c:	6105                	addi	sp,sp,32
  80027e:	8082                	ret
  800280:	4405                	li	s0,1
  800282:	b7f5                	j	80026e <cputs+0x2a>

0000000000800284 <fprintf>:
  800284:	715d                	addi	sp,sp,-80
  800286:	02010313          	addi	t1,sp,32
  80028a:	f032                	sd	a2,32(sp)
  80028c:	f436                	sd	a3,40(sp)
  80028e:	f83a                	sd	a4,48(sp)
  800290:	86ae                	mv	a3,a1
  800292:	0050                	addi	a2,sp,4
  800294:	85aa                	mv	a1,a0
  800296:	871a                	mv	a4,t1
  800298:	00000517          	auipc	a0,0x0
  80029c:	f2450513          	addi	a0,a0,-220 # 8001bc <fputch>
  8002a0:	ec06                	sd	ra,24(sp)
  8002a2:	fc3e                	sd	a5,56(sp)
  8002a4:	e0c2                	sd	a6,64(sp)
  8002a6:	e4c6                	sd	a7,72(sp)
  8002a8:	e41a                	sd	t1,8(sp)
  8002aa:	c202                	sw	zero,4(sp)
  8002ac:	1d4000ef          	jal	ra,800480 <vprintfmt>
  8002b0:	60e2                	ld	ra,24(sp)
  8002b2:	4512                	lw	a0,4(sp)
  8002b4:	6161                	addi	sp,sp,80
  8002b6:	8082                	ret
...
00000000008002b8 <initfd>:
  ...
  8002c8:	ec3ff0ef          	jal	ra,80018a <open>
  ...
  8002e4:	eafff0ef          	jal	ra,800192 <close>
  8002e8:	85a6                	mv	a1,s1
  8002ea:	8522                	mv	a0,s0
  8002ec:	eb3ff0ef          	jal	ra,80019e <dup2>
  8002f0:	84aa                	mv	s1,a0
  8002f2:	8522                	mv	a0,s0
  8002f4:	e9fff0ef          	jal	ra,800192 <close>
...
00000000008002fc <umain>:
  ...
  800338:	e0dff0ef          	jal	ra,800144 <exit>
  ...
  800350:	d11ff0ef          	jal	ra,800060 <__warn>
  ...
  80036a:	cf7ff0ef          	jal	ra,800060 <__warn>
...
0000000000800962 <readline>:
  ...
  800982:	4505                	li	a0,1
  800984:	901ff0ef          	jal	ra,800284 <fprintf>
  ...
  8009a6:	4501                	li	a0,0
  8009a8:	feeff0ef          	jal	ra,800196 <read>
  ...
  8009ca:	4505                	li	a0,1
  8009cc:	8b9ff0ef          	jal	ra,800284 <fprintf>
  ...
  8009e6:	fb0ff0ef          	jal	ra,800196 <read>
  ...
  800a16:	4505                	li	a0,1
  800a18:	86dff0ef          	jal	ra,800284 <fprintf>
  ...
  800a32:	4505                	li	a0,1
  800a34:	851ff0ef          	jal	ra,800284 <fprintf>
...
0000000000800a58 <reopen>:
  ...
  800a68:	f2aff0ef          	jal	ra,800192 <close>
  800a6c:	8522                	mv	a0,s0
  800a6e:	85ca                	mv	a1,s2
  800a70:	f1aff0ef          	jal	ra,80018a <open>
  ...
  800a98:	efaff0ef          	jal	ra,800192 <close>
  800a9c:	85a6                	mv	a1,s1
  800a9e:	8522                	mv	a0,s0
  800aa0:	efeff0ef          	jal	ra,80019e <dup2>
  800aa4:	84aa                	mv	s1,a0
  800aa6:	8522                	mv	a0,s0
  800aa8:	eeaff0ef          	jal	ra,800192 <close>
...
0000000000800ab0 <testfile>:
  ...
  800ab6:	ed4ff0ef          	jal	ra,80018a <open>
  800aba:	87aa                	mv	a5,a0
  800abc:	00054563          	bltz	a0,800ac6 <testfile+0x16>
  800ac0:	ed2ff0ef          	jal	ra,800192 <close>
  800ac4:	4781                	li	a5,0
...
0000000000800ace <runcmd>:
  ...
  800b26:	4505                	li	a0,1
  800b28:	f5cff0ef          	jal	ra,800284 <fprintf>
  800b2c:	54fd                	li	s1,-1
  ...
  800c0e:	d4cff0ef          	jal	ra,80015a <fork>
  800c12:	87aa                	mv	a5,a0
  800c14:	f539                	bnez	a0,800b62 <runcmd+0x94>
  800c16:	d7cff0ef          	jal	ra,800192 <close>
  800c1a:	4581                	li	a1,0
  800c1c:	4501                	li	a0,0
  800c1e:	d80ff0ef          	jal	ra,80019e <dup2>
  800c22:	84aa                	mv	s1,a0
  800c24:	f00545e3          	bltz	a0,800b2e <runcmd+0x60>
  800c28:	4501                	li	a0,0
  800c2a:	d68ff0ef          	jal	ra,800192 <close>
  800c2e:	4501                	li	a0,0
  800c30:	d62ff0ef          	jal	ra,800192 <close>
  ...
  800c80:	ce2ff0ef          	jal	ra,800162 <__exec>
...
0000000000800cc6 <main>:
  ...
  800cdc:	d68ff0ef          	jal	ra,800244 <cputs>
  800ce0:	4789                	li	a5,2
  ...
  800d36:	4505                	li	a0,1
  800d38:	d4cff0ef          	jal	ra,800284 <fprintf>
  ...
  800d58:	4505                	li	a0,1
  800d5a:	d2aff0ef          	jal	ra,800284 <fprintf>
  800d5e:	557d                	li	a0,-1
  ...
  800d8a:	bbaff0ef          	jal	ra,800144 <exit>
